...
template.url = "https://github.com/toastygm/hm-adv-sos";
template.bugs = "https://github.com/toastygm/hm-adv-sos/issues";
template.manifest =
    "https://github.com/toastygm/hm-adv-sos/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-adv-sos/releases/download/v${pkg.version}/module.zip`;
